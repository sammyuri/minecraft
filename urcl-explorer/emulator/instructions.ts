...
export enum IO_Port {
    ...
    //CHUNGUS custom IO
        ...
        PLAYERINPUT,
        //block RAM
        BLOCKRAM_X, BLOCKRAM_OOBACTIVE = BLOCKRAM_X, BLOCKRAM_Y, BLOCKRAM_OOBINACTIVE = BLOCKRAM_Y, BLOCKRAM_Z, BLOCKRAM_ZI = BLOCKRAM_Z, BLOCKRAM_ID,
        //blockToMesh
        MESHGEN_BLOCKXZ, MESHGEN_BLOCKY, MESHGEN_ITEMXZ, MESHGEN_ITEMY, MESHGEN_BREAKPHASE, MESHGEN_ITEMID, MESHGEN_DIRECTION, MESHGEN_SETTINGS,
        MESHGEN_RENDERFACE = MESHGEN_BREAKPHASE, MESHGEN_RENDERITEM = MESHGEN_ITEMID, MESHGEN_RENDEROVERLAY = MESHGEN_DIRECTION, MESHGEN_RENDERSCENE = MESHGEN_SETTINGS,
        //AMOGUS
